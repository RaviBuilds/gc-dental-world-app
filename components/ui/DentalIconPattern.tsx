        ...
        <defs>
          <pattern id={id} width="280" height="280" patternUnits="userSpaceOnUse">
            {/* Tooth — anchor glyph, ~28px, tilted -8deg, sits low-left where
                the fade mask peaks */}
            <g transform="translate(96 128) rotate(-8) scale(1.5)" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <g transform="translate(206 56) rotate(15) scale(0.62)" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8L12 3Z" />
            </g>
            {/* Shield — lower-right satellite */}
            <g transform="translate(198 216) rotate(-10) scale(0.65)" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
